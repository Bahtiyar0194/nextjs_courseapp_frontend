...
import { AiOutlineCalendar, AiOutlineColumnHeight, AiOutlineEdit, AiOutlineSearch, AiOutlineUndo, AiOutlineFile, AiOutlineFileAdd, AiOutlinePlayCircle, AiOutlineAudio } from "react-icons/ai";
...
export default function Files() {
    ...
    const closePreviewFileModal = (preview_file) => {
        ...
        else if (preview_file.file_type_id == 3) {
                ...
                <div className="col-span-12 lg:col-span-3">
                    <StickyBox offsetTop={6} offsetBottom={6}>
                        <div className="custom-grid">
                            ...
                            <div className={"col-span-12 " + (search_file_filter === true ? 'block' : 'hidden')}>
                                <div className="card p-4">
                    ...
                    {disk_data?.files_count > 0
                        ...
                        files.data?.length > 0 ?
                            <>
                                                                ...
                                                                <td>
                                                                    {
                                                                        file.file_type_id == 1
                                                                            ...
                                                                            file.file_type_id == 3
                                                                                ...
                                                                                file.file_type_id == 4
                                                                                    ?
                                                                                    <div className="w-10 h-10 bg-center bg-cover bg-no-repeat rounded-lg" style={{ backgroundImage: "url(" + API_URL + '/media/image/' + file.file_id + ")" }}></div>
                                                                                    :
                                                                                    <></>
                                                                    }
                                                                </td>
                                                        ...
                                                        <div className="card p-2 hover:cursor-pointer" onClick={e => openPreviewFileModal(file)}>
                                                            {
                                                                file.file_type_id == 1
                                                                    ...
                                                                    file.file_type_id == 3
                                                                        ...
                                                                        file.file_type_id == 4
                                                                            ?
                                                                            <div className="w-full h-24 sm:h-48 lg:h-36 bg-center bg-cover bg-no-repeat rounded-lg" style={{ backgroundImage: "url(" + API_URL + '/media/image/' + file.file_id + ")" }}></div>
                                                                            :
                                                                            <></>
                                                            }
                                ...
                                <Modal show={preview_file_modal} onClose={() => closePreviewFileModal(preview_file)} modal_title={preview_file.file_name} modal_size="modal-4xl">
                                    <PreviewFileModal
                                        file={preview_file}
                        ...
                        :
                        <Alert className="alert light" text={"Вы не загрузили ни одного файла"} />
                    }
                </div>
            </RoleProvider>
        </DashboardLayout>
